  ...
  return (
    <footer className="border-t bg-[#1d293d] text-primary-foreground">
      <div className="container grid gap-8 py-10 md:grid-cols-[1.5fr_1fr_1fr]">
        <div>
          <p className="text-xl font-black">Gut Klinik Fisioterapia</p>
          <p className="mt-3 max-w-md text-sm text-primary-foreground/75">
            Tu salud física y recuperación son nuestra prioridad. Brindamos atención de fisioterapia de la más alta calidad en la Ciudad de México.
          </p>
        </div>
        <div>
