    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-start">
        ...
        <div className="flex items-start gap-4">
            ...
            <p className="mt-1 text-slate-600 leading-relaxed">
                {/* {business?.address} */}
                Calz Acoxpa 419, Coapa, Villa Lázaro Cárdenas, Tlalpan, 14370 Ciudad de México, CDMX
            </p>
            </div>
        </div>
        ...
        <div className="flex items-start gap-4">
            ...
            <p className="mt-1 text-slate-600">
                <a href="tel:+525524948191" className="hover:text-primary-600 transition-colors font-medium">
                    {/* {business?.phone} */}
                    +52 55 2494 8191
                </a>
            </p>
        ...
        <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d30125.205622157882!2d-99.1384657!3d19.2975504!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85ce01a934bd8e59%3A0x805bc138b52e5185!2sCl%C3%ADnica%20de%20Belleza%20ACOXPA%20419!5e0!3m2!1ses-419!2smx!4v1785443144023!5m2!1ses-419!2smx"
            width="100%" 
            height="100%" 
            style={{ border: 0 }} 
