    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-start">
        ...
        <div className="flex items-start gap-4">
            ...
            <p className="mt-1 text-slate-600 leading-relaxed">
                {business?.address || "Calzada del Hueso, Fuentes Plaza 160-Local 5b, Ex-Hacienda Coapa, Coyoacán, 04980 CDMX"}
            </p>
            </div>
        </div>
        ...
        <div className="flex items-start gap-4">
            ...
            <p className="mt-1 text-slate-600">
                <a href="tel:+525529711036" className="hover:text-primary-600 transition-colors font-medium">{business?.phone || "55 2971 1036"}</a>
            </p>
            </div>
        </div>
        ...
        <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3764.912648834988!2d-99.1245086!3d19.2974917!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85ce019623e105e1%3A0xc3169824f1c1f727!2sDental%20Plaza!5e0!3m2!1ses!2smx!4v1700000000000!5m2!1ses!2smx"
            width="100%" 
            height="100%" 
            style={{ border: 0 }} 
            ...
            title="Mapa de Dental Plaza en Coyoacán"
        ></iframe>
        </div>
    </div>
  )
