  ...
  return (
    <header className="sticky top-0 z-50 border-b bg-background/85 backdrop-blur-xl">
      <div className="container flex h-20 items-center justify-between gap-4">
        <Link href="/" className="flex items-center gap-3" aria-label="Ir al inicio de el Salon">
          <span>
            <span className="block text-xl font-black tracking-tight text-primary">el Salon</span>
            <span className="hidden text-xs text-muted-foreground sm:block">Centro de estética en Coapa</span>
          </span>
        </Link>
