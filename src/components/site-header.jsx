  ...
  return (
    <header className="sticky top-0 z-50 border-b bg-background/85 backdrop-blur-xl">
      <div className="container flex h-20 items-center justify-between gap-4">
        <Link href="/" className="flex items-center gap-3" aria-label="Ir al inicio de Gut Klinik Fisioterapia">
          <span>
            <span className="block text-lg font-black tracking-tight">Gut Klinik Fisioterapia</span>
            <span className="hidden text-xs text-muted-foreground sm:block">Fisioterapia en CDMX</span>
          </span>
        </Link>
